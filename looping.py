...
while True:
    ...
    if snake_position[0] < 0:
        snake_position[0] = window_x - snake_block_size
    elif snake_position[0] >= window_x:
        snake_position[0] = 0
    elif snake_position[1] < 0:
        snake_position[1] = window_y - snake_block_size
    ...
    pygame.draw.rect(game_window, white, pygame.Rect(fruit_position[0], fruit_position[1], snake_block_size,
                                                     snake_block_size))
