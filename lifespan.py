...
while True:
    ...
    # Decrease snake body length every 10 seconds
    time_elapsed += fps.get_time()
    ...
    time_remaining -= fps.get_time()
    time_surface = score_font.render('Time: ' + str(time_remaining // 1000), True, white)
    game_window.blit(time_surface, (10, 30))
