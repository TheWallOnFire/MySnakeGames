...
for _ in range(wall_num):  # Adjust the number of walls as needed
    wall_position = [random.randrange(1, (window_x // snake_block_size)) * snake_block_size, random.randrange(1, (window_y // snake_block_size)) * snake_block_size]
...
while True:
    # Draw walls
    for wall in walls:
        pygame.draw.rect(game_window, blue, pygame.Rect(wall[0], wall[1], snake_block_size, snake_block_size))
